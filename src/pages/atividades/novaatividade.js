...
class NovaAtividade extends FrmPadrao {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll(async (err, values) => {
      if (!err) {
        ...
        try {
          const response = await api.post("/novaatividade", formData);
    ...
    return (
      <MasterPage tituloCabecalho='titulo inicial'>
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Cad. Atividade</Breadcrumb.Item>
        </Breadcrumb>
...
export default Form.create()(NovaAtividade);