...
class NovaMateria extends FrmPadrao {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll(async (err, values) => {
      if (!err) {
        ...
        try {
          const response = await api.post("/novamateria", formData);
    ...
    return (
      <MasterPage tituloCabecalho='titulo inicial'>
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Cad. Materia</Breadcrumb.Item>
        </Breadcrumb>
            ...
            <Form {...this.layoutSideBySyde} onSubmit={this.handleSubmit} contextMenu="" >
              ...
              <Form.Item
                ...
                {getFieldDecorator('titulo', {
                  rules: [{ required: true, message: 'Informe a título da matéria!', whitespace: true }],
                })(<Input />)}
              </Form.Item>
              ...
              <Form.Item {...this.LayoutFullWidth}>
                {getFieldDecorator('materia', {
                  rules: [{ required: true, message: 'Nenhum texto foi escrito nesta matéria!' }],
                })(
                  <Editor
                    init={{
                      setup: editor => {
...
export default Form.create()(NovaMateria);